...
interface PlaylistViewProps {
  playlistId: string;
  initialPlaylist: any | null;
}

export function PlaylistView({ playlistId, initialPlaylist }: PlaylistViewProps) {
  ...
  if (!playlist) {
    return (
      <div className="p-12 text-center text-on-surface-muted font-semibold">
        Playlist not found.
      </div>
    );
  }
...
function PlaylistSkeleton() {
  return (
    <div className="pb-24 animate-fade-in">
      <div
        className="px-4 md:px-8 pt-8 pb-6 border-b-2 border-prussian-blue/20"
        style={{ background: '#E2720A' }}
      >
